...
>>>>>>> 0e60254fd73925511718d927f4c14d94c4f98d18
...
Date and Method of Original Data Collection: These data were collected from the Coffee Quality Institute's review pages in January 2018. These data contain 
reviews of 1312 arabica and 28 robusta coffee beans from the Coffee Quality Institute's trained reviewers.
...
What is the relationship between the average altitude of the farm and the 
sweetness level of the coffee based on the country where the coffee was 
produced?

This question is important because the results of this study will demonstrate 
which country and at which altitude the coffee will be the sweetest or least 
sweet. This information will be important for coffee farmers who wish to produce sweet coffee (or vice versa) for their customers.

Our research will investigate the relationship between the average altitude of 
farm where the coffee is grown and the sweetness level of the coffee produced 
based on the country where the coffee was produced. We hypothesize that there 
will be a positive correlation between the altitude and sweetness, because the 
literature showed that coffee beans grown at higher altitudes made coffee with
a better taste. 

The variable "Location.Country" (country where the coffee is produced) is a categorical variable, whereas the variables "Data.Scores.Sweetness" (sweetness 
level of the coffee on a scale of 1-10) and "Location.Altitude.Average"
(the average altitude of the farm in which the coffee was grown) are 
quantitative variables.

LITERATURE

This research article discusses the research into the sensory information about four different types of coffee, and how these attributes compared when coffee 
was grown at two different altitudes in the San Martin region of Peru. There was 
a 200 meter difference in the altitudes of coffee being grown and an ample 
amount -- 1500g -- of each type of coffee was grown in each location. Sensory factors "such as aroma, taste, aftertaste, acidity, body, consistency, balance, cleanliness of the cup, sweetness and beverage quality" were measured based on tables approved by the Specialty Coffee Association of America (SCAA). Moreover, the coffee tasters used to assess the coffee for this experiment were "certified 
by the Cooperativa Agraria Cafetalera y de Servicios Oro Verde". 
...
Liliana, E. G., Vallejos-Torres, G., & Luis Arévalo López. (2017). 
Sensory analysis of four cultivars of coffee (0RW1S34RfeSDcfkexd09rT2Coffea arabica1RW1S34RfeSDcfkexd09rT2 L.), grown at different altitudes in the San 
Martin region - Peru. Ciência Rural, 47(9). https://doi.org/10.1590/0103-8478cr20160882. 
