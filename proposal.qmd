...
library(tidyverse)
```
>>>>>>> d3121493cec11b7efab07a7a8821c65db51938d0
# Data 1
...
https://www.rochester.edu/newscenter/nasa-brings-standards-of-evidence-to-the-search-for-ufos-527122/ https://www.rochester.edu/newscenter/nasa-brings-standards-of-evidence-to-the-search-for-ufos-527122/
...
South_Dakota_COVID19_Feature_Layer_1_ <- read_excel("data/South_Dakota_COVID19_Feature_Layer (1).xlsx")
```
...
=======
-   Identify the source of the data. The source of this data is data.gov.
>>>>>>> d3121493cec11b7efab07a7a8821c65db51938d0
...
-   The observations collect data about UFO sightings worldwide, from date and time to city area, date documented, and more specific information about the description of the UFO, from size to lights.
=======
It was found through the information reported by the South Dakota Department of Health through medical records. It is continually collected, but our set spans from March 17th, 2020 to March 3rd, 2023.
...
UPDATED RESEARCH QUESTION: What is the most common shape and size of UFO based on what continent it is sighted on? How can this data be analyzed to consider whether or not UFOs are real and evidence of alien life?
=======
...
-   Several of the variables are categorical: date_time, city_area, state, country, ufo_shape, described_encounter_length, description, and date_documented. The quantitative variables are encounter_length, latitude, and longitude.
=======
This research topic will explore how the quatity of COVID testing effects different age and sex groups. We believe that COVID cases will effect older men the most, despite being the group with the least amount of aggregrate beliefs in COVID-19.
